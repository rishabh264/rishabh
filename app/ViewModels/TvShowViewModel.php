...
{
    public $tvshow;
    public $similertvshow;
    public $genres;

    public function __construct($tvshow, $similertvshow, $genres)
    {
        $this->tvshow = $tvshow;
        $this->similertvshow = $similertvshow;
        $this->genres = $genres;
    }

     public function similertvshow()
    {
        return $this->formatTv($this->similertvshow);
    }
