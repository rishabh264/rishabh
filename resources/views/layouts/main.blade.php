...
<body class="font-sans bg-teal-900 text-white">
    <nav class="border-b border-teal-800">
        <div class="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
            ...
            <ul class="flex flex-col md:flex-row items-center" id="main-nav">
                <li>
                    <a href="{{url('/')}}">
               ...
               <!--  <li class="md:ml-16 mt-3 md:mt-0">
                    ...
                    <div class="">
                      <div class="dropdown relative">
                        ...
                        <ul class="dropdown-menu absolute hidden text-gray-700 pt-1 " >
                          <li class="md:ml-6 mt-3 md:mt-0"><a class="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="{{url('/popular-movies')}}">Popular Movies</a></li>
                          <li class="md:ml-6 mt-3 md:mt-0"><a class="bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="{{url('/now-playing')}}">Now Playing</a></li>
                          <li class="md:ml-6 mt-3 md:mt-0"><a class=" bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="{{url('/upcoming')}}">Upcoming</a></li>
                          <li class="md:ml-6 mt-3 md:mt-0"><a class="rounded-b bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="{{url('/top-rated')}}">Top Rated</a></li>
                        </ul>
                      </div>
                    </div>
                </li>
                ...
                <li class="md:ml-6 mt-3 md:mt-0">
                    <div class="">
                      <div class="dropdown relative">
                        ...
                        <ul class="dropdown-menu absolute hidden text-gray-700 pt-1 " >
                          <li class="md:ml-6 mt-3 md:mt-0"><a class="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="{{ route('tv.index') }}">Popular</a></li>
                          <li class="md:ml-6 mt-3 md:mt-0"><a class="bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="{{url('/airing-today')}}">Airing Today</a></li>
                          <li class="md:ml-6 mt-3 md:mt-0"><a class=" bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="{{url('/on-tv')}}">On Tv</a></li>
                          <li class="md:ml-6 mt-3 md:mt-0"><a class="rounded-b bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="{{url('/top-rated-tv')}}">Top Rated</a></li>
                        </ul>
                      </div>
                    </div>
                </li>
                ...
                <li class="md:ml-6 mt-3 md:mt-0">
                    <div class="">
                      <div class="dropdown relative">
                        <button class="">
                          <span class="mr-1 ">People</span>
                        </button>

                        <ul class="dropdown-menu absolute hidden text-gray-700 pt-1 " >
                          <li class="md:ml-6 mt-3 md:mt-0"><a class=" bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="{{ route('actors.index') }}">Popular People</a></li>
               ...
               <!--  <li class="md:ml-6 mt-3 md:mt-0">
                    <div class="">
                      <div class="dropdown relative">
                        ...
                        <ul class="dropdown-menu absolute hidden text-gray-700 pt-1 " >
                          <li class="md:ml-6 mt-3 md:mt-0"><a class="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="#">One</a></li>
                          <li class="md:ml-6 mt-3 md:mt-0"><a class="bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="#">Two</a></li>
                          <li class="md:ml-6 mt-3 md:mt-0"><a class="rounded-b bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="#">Three is the magic number</a></li>
                        </ul>
                      </div>
                    </div>
                </li> -->
